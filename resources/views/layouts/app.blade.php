...
<head>
    ...
    <title>{{ $metaTitle ?: 'Laravel Blog Template' }}</title>
...
<body class="bg-gray-50 font-family-karla">
    ...
    <div class="container mx-auto flex flex-wrap py-6 xl:px-20">
    ...
    <footer class="w-full border-t bg-white pb-12">
        <div class="w-full container mx-auto flex flex-col items-center">
            <div class="uppercase py-6 cursor-pointer"><a href="/">&copy; selimsahin.xyz</a></div>
        </div>
    </footer>
